      ...
      merge into `arcane-pillar-485809-b6`.`snapshots`.`customers_snapshot` as DBT_INTERNAL_DEST
    using `arcane-pillar-485809-b6`.`snapshots`.`customers_snapshot__dbt_tmp` as DBT_INTERNAL_SOURCE
